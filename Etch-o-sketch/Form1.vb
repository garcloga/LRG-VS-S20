Public Class Form1
    ...
    Private Sub PictureBox1_MouseMove(sender As Object, e As MouseEventArgs) Handles PictureBox1.MouseMove
        ...
        graph = PictureBox1.CreateGraphics 'create the graphics object
    ...
    Private Sub ChangeColorButton_Click(sender As Object, e As EventArgs) Handles ChangeColorButton.Click
        ...
        penColor = ColorDialog1.Color 'makes the pen the color that was chosen
        myPen.Color = penColor 'setting the mouse as the pen
    End Sub
    ...
    Private Sub EraseButton_Click(sender As Object, e As EventArgs) Handles EraseButton.Click
        ...
        For i = 1 To 3
            For j = 1 To 9000000 'shaking the screen
                If j < 4500000 Then
                    Me.Top = oldTop - 50
                Else
                    Me.Top = oldTop
